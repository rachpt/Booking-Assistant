...
class SettingPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.choose_firefox = tk.Radiobutton(self,
                                             text='Firefox',
                                             variable=self.var_browser,
                                             value='Firefox',
                                             command=self.set_browser)
        self.choose_chrome = tk.Radiobutton(self,
                                            text='Chrome',
                                            variable=self.var_browser,
                                            value='Chrome',
                                            command=self.set_browser)

        self.entry_browser_path = tk.Entry(self,
        ...
        self.button_path = Button(self,
                                  text="...",
                                  command=self.select_brower_path)
        ...
        self.ertry_pa_name = tk.Entry(self.frame,
                                      textvariable=self.var_pa_name)
        ...
        self.label_notice = Label(self.frame,
                                  text="**该部分目前无法验证是否有效**",
                                  fg='red',
                                  font=("Helvetica", 12))
    ...
    def update_button_bar(self):
        ...
        if self.is_checking.get():
            ...
            self.button_checking.place(x=middle-25,
                                y=top + (height + hspace) * 4 + height * 3 +
                                f_y * 4 + hspace + height + 10,
                                width=250,
                                height=height + 10)
        else:
            self.button_login.place(x=middle,
                                y=top + (height + hspace) * 4 + height * 3 +
                                f_y * 4 + hspace,
                                width=200,
                                height=height + 10)
    ...
    def create_page(self):
        ...
        self.label_pwd.place(x=160,
                             ...
                             width=middle - 160,
                             height=height)
        self.label_browser.place(x=190,
                                 y=top + (height + hspace) * 2,
                                 width=middle - 190,
                                 height=height)
        ...
        self.entry_pwd.place(x=middle,
                             ...
                             width=250,
                             height=height)
        self.choose_firefox.place(x=middle,
                                  y=top + (height + hspace) * 2,
                                  width=80,
                                  height=height)
        self.choose_chrome.place(x=middle + 90,
                                 y=top + (height + hspace) * 2,
                                 width=80,
                                 height=height)
        ...
        if backend.is_win:
        # if True:
            self.label_browser_path.place(x=190-70,
                                          y=top + (height + hspace) * 3,
                                          width=middle - 190,
                                          height=height)
            self.entry_browser_path.place(x=middle-70,
                                          y=top + (height + hspace) * 3,
                                          width=250 + 70 * 2,
                                          height=height)

            self.button_path.place(x=middle + 260 + 70,
                                   y=top + (height + hspace) * 3,
                                   width=40,
                                   height=height)
        ...
        self.ertry_pa_pwd.place(x=f_x + f_w1,
                                ...
                                width=f_w2,
                                height=height)
        self.label_notice.place(x=f_x + f_w1 + f_w2 + f_spx,
                                y=f_y * 2 + height - 5,
                                width=f_w1 + f_w2,
                                height=height + 10)
    ...
    def set_browser(self):
        ...
        if self.var_browser.get() == 'Firefox':
            if not self.var_browser_path.get() or self.var_browser_path.get(
            ) == default_chrome_path:
    ...
    def verification(self, auto = False):
        ...
        try:
            ...
            if backend.get_cookie(user_info):
